...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SET_REQUEST_MANAGER; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return SET_SUBSETS; });
var SET_REQUEST_MANAGER = 'SET_REQUEST_MANAGER';
var SET_SUBSETS = 'SET_SUBSETS';
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(60), __webpack_require__(61)))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_charts_correlation_analysis_vue__ = __webpack_require__(338);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_charts_correlation_analysis_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__components_charts_correlation_analysis_vue__);
...
var ChartManager = function () {
  function ChartManager() {
    ...
    this.AVAILABLE_CHARTS = {
      'correlation-analysis': __WEBPACK_IMPORTED_MODULE_1__components_charts_correlation_analysis_vue___default.a
    };
  }
  ...
  _createClass(ChartManager, [{
    ...
    value: function setChart() {
      ...
      var Chart = __WEBPACK_IMPORTED_MODULE_0_vue__["a" /* default */].extend(this.AVAILABLE_CHARTS[name]);
      var vm = new Chart();
      vm.$mount(elementId);
    }
  }]);
...
var RequestManager = function () {
  function RequestManager() {
    var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
        ...
        thisBaseURL = _ref.thisBaseURL,
        fractalisBaseURL = _ref.fractalisBaseURL,
    ...
    this._axios = __WEBPACK_IMPORTED_MODULE_0_axios___default.a.create({
  ...
  _createClass(RequestManager, [{
    key: 'createData',
    value: function createData(descriptors) {
    ...
    key: 'getDataStatusByParams',
    value: function getDataStatusByParams(descriptor) {
      var params = JSON.stringify({ server: this._thisBaseURL, descriptor: descriptor });
      this._axios.get('/data/' + params).then(function (response) {
        console.log(response);
      }).else(function (error) {
        console.log(error);
      });
    ...
    key: 'getDataStatusByID',
    value: function getDataStatusByID(dataID) {
      this._axios.get('/data/' + dataID).then(function (response) {
        console.log(response);
      }).else(function (error) {
        console.log(error);
      });
    ...
    key: 'getAllDataStatus',
    value: function getAllDataStatus() {
      this._axios.get('/data').then(function (response) {
        console.log(response);
      }).else(function (error) {
        console.log(error);
      });
    ...
    key: 'creareAnalysis',
    value: function creareAnalysis(name, args) {
    ...
    value: function getAnalysisStatus(jobID) {
      this._axios.get('/analytics/' + jobID).then(function (response) {
        console.log(response);
      }).else(function (error) {
        console.log(error);
      });
    ...
    key: 'cancelAnalysis',
    value: function cancelAnalysis(jobID) {
      this._axios.delete('/analytics/' + jobID).then(function (response) {
        console.log(response);
      }).else(function (error) {
        console.log(error);
      });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__getters__ = __webpack_require__(148);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__actions__ = __webpack_require__(147);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__mutation_types__ = __webpack_require__(94);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setRequestManager", function() { return setRequestManager; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setSubsets", function() { return setSubsets; });


var setRequestManager = function setRequestManager(_ref, manager) {
  var commit = _ref.commit;

  commit(__WEBPACK_IMPORTED_MODULE_0__mutation_types__["a" /* SET_REQUEST_MANAGER */], manager);
};

var setSubsets = function setSubsets(_ref2, subsets) {
  var commit = _ref2.commit;

  commit(__WEBPACK_IMPORTED_MODULE_0__mutation_types__["b" /* SET_SUBSETS */], subsets);
};
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__mutation_types__ = __webpack_require__(94);
var _types$SET_REQUEST_MA;

function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }



/* harmony default export */ __webpack_exports__["a"] = _types$SET_REQUEST_MA = {}, _defineProperty(_types$SET_REQUEST_MA, __WEBPACK_IMPORTED_MODULE_0__mutation_types__["a" /* SET_REQUEST_MANAGER */], function (state, _ref) {
  var manager = _ref.manager;

  state.requestManager = manager;
}), _defineProperty(_types$SET_REQUEST_MA, __WEBPACK_IMPORTED_MODULE_0__mutation_types__["b" /* SET_SUBSETS */], function (state, _ref2) {
  var subsets = _ref2.subsets;

  state.subsets = subsets;
}), _types$SET_REQUEST_MA;
...
// module
exports.push([module.i, "\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n", "", {"version":3,"sources":[],"names":[],"mappings":"","file":"correlation-analysis.vue","sourceRoot":""}]);
...
var Component = __webpack_require__(339)(
  /* script */
...
Component.options.__file = "/Users/sascha/Workspace/fractaljs/src/components/charts/correlation-analysis.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] correlation-analysis.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-3f269516", Component.options)
  } else {
    hotAPI.reload("data-v-3f269516", Component.options)
  }
})()}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-3f269516", module.exports)
  }
}
...
var update = __webpack_require__(342)("452d0e3c", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js?sourceMap!../../../node_modules/vue-loader/lib/style-rewriter.js?{\"id\":\"data-v-3f269516\",\"scoped\":true,\"hasInlineConfig\":false}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./correlation-analysis.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js?sourceMap!../../../node_modules/vue-loader/lib/style-rewriter.js?{\"id\":\"data-v-3f269516\",\"scoped\":true,\"hasInlineConfig\":false}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./correlation-analysis.vue");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_request_manager__ = __webpack_require__(125);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_chart_manager__ = __webpack_require__(124);
...
var FractalJS = function () {
  function FractalJS(handler, thisBaseURL, fractalisBaseURL, getAuth) {
    _classCallCheck(this, FractalJS);

    var requestManager = new __WEBPACK_IMPORTED_MODULE_2__services_request_manager__["a" /* RequestManager */]({ handler: handler, thisBaseURL: thisBaseURL, fractalisBaseURL: fractalisBaseURL, getAuth: getAuth });
    __WEBPACK_IMPORTED_MODULE_1__store__["a" /* store */].dispatch('setRequestManager', requestManager);
    this._chartManager = new __WEBPACK_IMPORTED_MODULE_3__services_chart_manager__["a" /* ChartManager */]();
  }

  // noinspection JSMethodCanBeStatic


  _createClass(FractalJS, [{
    key: 'loadData',
    value: function loadData(descriptors) {
      __WEBPACK_IMPORTED_MODULE_1__store__["a" /* store */].requestManager.createData(descriptors);
    }
  }, {
    key: 'setChart',
    value: function setChart(name, elementId) {
      this._chartManager.setChart({ name: name, elementId: elementId });
    }
    ...
    key: 'setSubsets',
    value: function setSubsets() {
      for (var _len = arguments.length, subsets = Array(_len), _key = 0; _key < _len; _key++) {
        subsets[_key] = arguments[_key];
      }

      __WEBPACK_IMPORTED_MODULE_1__store__["a" /* store */].dispatch('setSubsets', subsets);
    }
  }]);
